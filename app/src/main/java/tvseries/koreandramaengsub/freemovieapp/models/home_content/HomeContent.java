...
package tvseries.koreandramaengsub.freemovieapp.models.home_content;
...
public class HomeContent {
    ...
    @SerializedName("topview_tvseries")
    @Expose
    private List<TopviewTvseries> topviewTvseries = null;
    @SerializedName("features_genre_and_movie")
    @Expose
    private List<FeaturesGenreAndMovie> featuresGenreAndMovie = null;

    public List<TopviewTvseries> getTopviewTvseries() {
        return topviewTvseries;
    }

    public void setTopviewTvseries(List<TopviewTvseries> topviewTvseries) {
        this.topviewTvseries = topviewTvseries;
    }
