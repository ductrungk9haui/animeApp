    ...
    public void onBindViewHolder(final NavigationAdapter.OriginalViewHolder holder, final int position) {
        ...
        if (position==0){
            ...
            if (menuStyle.equals("grid")) {
                ...
                holder.cardView.setCardBackgroundColor(ctx.getResources().getColor(R.color.colorPrimaryDark));
                ...
                holder.name.setTextColor(ctx.getResources().getColor(R.color.colorPrimaryDark));
            }
